...
export interface QFTokenInterface extends utils.Interface {
  functions: {
    ...
    "setRole(address,uint8)": FunctionFragment;
  ...
  events: {
    ...
    "SetName(address,bytes32)": EventFragment;
    "SetRole(address,uint8)": EventFragment;
...
export type SetNameEvent = TypedEvent<[string, string], SetNameEventObject>;
...
export type SetRoleEvent = TypedEvent<[string, number], SetRoleEventObject>;
...
export interface QFToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: QFTokenInterface;
